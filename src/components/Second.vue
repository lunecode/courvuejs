<template>
    ...
    <div0 class="parentPrincipal ni">
        ...
        <div2>
            ...
            <span v-if="estVisible"> {{ msg3 }} </span>
        </div2>
        <div3>
            <span v-once>Ceci ne changera jamais : {{ msg3 }} ||||</span>
        ...
        <div4>
            ...
            <img :src= "monImage" > 
            <!-- methode 2 -->
            <img v-bind:[elementDynamique]="monImage" />
        </div4>
        <div5>
